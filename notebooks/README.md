...
The project reformulates action recognition as a **multiple-choice question (MCQ)** task by introducing hard, visually grounded distractors, followed by fine-tuning and evaluation of state-of-the-art VLMs such as **Qwen3-VL**.
...
### 1. Distractor Generation (`/distractor_generation`)
